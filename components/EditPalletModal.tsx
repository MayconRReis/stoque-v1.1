...
export const EditPalletModal: React.FC<EditPalletModalProps> = ({ 
 ...
 >
 <div className="bg-slate-800 p-6 flex justify-between items-center border-b border-slate-800 ">
 ...
 <button onClick={onClose} className="w-8 h-8 flex items-center justify-center bg-slate-950 rounded-lg text-slate-500 hover:text-white transition-all">
 <X className="w-4 h-4" />
 </button>
 </div>
 ...
 {mode === 'assign' && (
 <div className="p-5 bg-slate-900 rounded-3xl border border-slate-800 mb-2">
 ...
 rows={3}
 className="w-full bg-amber-500/5 border border-amber-500/20 rounded-xl px-4 py-3 text-zinc-50 font-bold text-sm focus:border-amber-500 outline-none transition-all resize-none placeholder:text-amber-500/20 shadow-inner"
 ...
 ? 'bg-amber-500 hover:bg-amber-600 active:bg-amber-700 shadow-xl shadow-amber-900/40 text-zinc-50 ' 
 : (isOperatorEdit ? 'bg-amber-600 hover:bg-amber-500 shadow-xl shadow-amber-900/20 text-zinc-50 ' : 'bg-blue-600 hover:bg-blue-500 active:bg-blue-700 shadow-xl shadow-blue-900/40 text-zinc-50 ')
 }`}
 >
