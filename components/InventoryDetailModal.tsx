...
export const InventoryDetailModal: React.FC<InventoryDetailModalProps> = ({ isOpen, onClose, row, inspection, palletIdx }) => {
 ...
 return (
 <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-950 backdrop-blur-2xl p-4 overflow-y-auto">
 ...
 {isSupplies && (
 <div className="bg-slate-800 p-6 rounded-[32px] border border-slate-800 space-y-6">
 ...
 {!isSupplies && (
 <div className="bg-slate-800 p-6 rounded-[32px] border border-slate-800 space-y-4">
 ...
 <button onClick={onClose} className="w-full py-5 bg-blue-600 hover:bg-blue-500 text-zinc-50 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-xl shadow-blue-900/40 transition-all active:scale-95">Fechar Detalhes</button>
 </div>
 </div>
 </div>
 );
