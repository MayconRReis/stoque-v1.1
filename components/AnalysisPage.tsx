...
export const AnalysisPage: React.FC<AnalysisPageProps> = ({ pendingItems, availableSlots, allSlots, onConfirm, onReject, onEdit }) => {
 ...
 layout
 key={item.id} 
 className="bg-slate-900 backdrop-blur-xl border border-slate-800 rounded-[2rem] p-6 space-y-5 hover:border-blue-600/30 transition-all group relative overflow-hidden"
 >
 ...
 className="flex-[2] py-3 bg-blue-600 hover:bg-blue-500 text-zinc-50 rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2"
 >
 ...
 <AnimatePresence>
 {selectedItem && (
 <div className="fixed inset-0 z-[150] flex items-center justify-center bg-slate-950 backdrop-blur-xl p-4 overflow-y-auto">
 <motion.div 
 ...
 <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-zinc-50 shadow-xl">
 ...
 className="flex-[2] py-3 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 text-zinc-50 rounded-xl font-bold text-[10px] uppercase tracking-widest shadow-lg shadow-blue-900/20 transition-all flex items-center justify-center gap-2"
 >
 {isProcessing ? (
