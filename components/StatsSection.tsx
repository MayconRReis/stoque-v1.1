...
const StatsSection: React.FC<StatsSectionProps> = ({ stats, isPublicView, onNavigate }) => {
 ...
 <div className="bg-slate-900 p-8 rounded-[2.5rem] border border-slate-800 shadow-2xl hover:border-blue-500/30 transition-all relative overflow-hidden group">
 ...
 <div className="bg-slate-900 p-8 rounded-[2.5rem] border border-slate-800 shadow-2xl hover:border-green-500/30 transition-all relative overflow-hidden group">
 <div className="absolute top-0 right-0 p-10 opacity-[0.03] group-hover:opacity-10 transition-opacity">
 ...
 {/* Registros */}
 <div 
 className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl flex items-center gap-4 group hover:border-indigo-500/30 transition-all cursor-pointer" 
 ...
 {/* Alocados */}
 <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl flex items-center gap-4 hover:border-emerald-500/30 transition-all">
 ...
 <div 
 className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl flex items-center gap-4 group hover:border-blue-500/30 transition-all cursor-pointer"
 ...
 <div 
 className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl flex items-center gap-4 group hover:border-amber-500/30 transition-all cursor-pointer"
 onClick={() => !isPublicView && onNavigate('shipments')}
 >
 ...
 <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl flex items-center gap-4 hover:border-indigo-500/30 transition-all">
 ...
 <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl flex items-center gap-4 hover:border-fuchsia-500/30 transition-all">
