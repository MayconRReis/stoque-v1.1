...
const InventoryCard: React.FC<InventoryCardProps> = ({ 
 ...
 className="flex-1 py-2.5 bg-slate-950 hover:bg-slate-800 text-slate-400 border border-slate-800 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2"
 >
 ...
 className={`flex-1 py-2.5 bg-slate-950 hover:bg-${baseColor}-500/10 text-${baseColor}-400 border border-slate-800 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2`}
 >
 ...
 className="p-2.5 bg-slate-950 hover:bg-red-600/10 text-red-500 border border-slate-800 rounded-xl transition-all flex items-center justify-center"
