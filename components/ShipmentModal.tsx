...
export const ShipmentModal: React.FC<ShipmentModalProps> = ({ 
 ...
 <div className="w-10 h-10 bg-fuchsia-600 rounded-xl flex items-center justify-center text-zinc-50 shadow-xl">
 ...
 className="group p-6 bg-slate-950 border border-slate-800 hover:border-fuchsia-500/50 rounded-3xl text-left transition-all hover:bg-slate-800 "
 >
 ...
 className="group p-6 bg-slate-950 border border-slate-800 hover:border-pink-500/50 rounded-3xl text-left transition-all hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <div className="flex items-center gap-4">
 ...
 className={`py-3 rounded-xl font-bold text-[10px] uppercase tracking-widest border transition-all ${type === ShipmentType.THIRD_PARTY ? 'bg-fuchsia-600 border-fuchsia-400 text-zinc-50 shadow-lg shadow-fuchsia-900/20' : 'bg-slate-950 border-slate-800 text-slate-500 hover:border-slate-700 '}`}
 >
 Terceirista
 </button>
 <button 
 onClick={() => setType(ShipmentType.OWN)}
 className={`py-3 rounded-xl font-bold text-[10px] uppercase tracking-widest border transition-all ${type === ShipmentType.OWN ? 'bg-pink-600 border-pink-400 text-zinc-50 shadow-lg shadow-pink-900/20' : 'bg-slate-950 border-slate-800 text-slate-500 hover:border-slate-700 '}`}
 >
 Próprio
 </button>
 </div>
 ...
 className="flex-[2] py-4 bg-fuchsia-600 hover:bg-fuchsia-500 disabled:bg-slate-800 text-zinc-50 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-fuchsia-900/40 transition-all flex items-center justify-center gap-2"
 >
 {isProcessing ? (
