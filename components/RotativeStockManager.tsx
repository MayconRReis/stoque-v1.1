...
export const RotativeStockManager: React.FC<RotativeStockManagerProps> = ({
 ...
 className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-zinc-50 rounded-2xl font-bold text-xs uppercase tracking-widest flex items-center gap-2 shadow-lg shadow-blue-900/20 transition-all border border-blue-400/20"
 >
 ...
 className="w-full bg-slate-900 border border-slate-800 rounded-2xl px-12 py-4 text-white font-bold text-sm focus:border-blue-500/50 outline-none transition-all placeholder:text-slate-700"
 />
 </div>
 ...
 typeFilter === type ? 'bg-blue-600 text-zinc-50 shadow-lg shadow-blue-900/20' : 'text-slate-500 hover:text-slate-300 '
 }`}
 >
 {type === 'ALL' ? 'Todos' : type}
 </button>
 ...
 key={slotId}
 className="bg-slate-900 p-6 rounded-[2.5rem] border border-slate-800 shadow-2xl space-y-4 hover:border-slate-700 transition-all transition-transform hover:scale-[1.01] group"
 >
 ...
 className="bg-slate-950 p-4 rounded-2xl border border-slate-800 group/item hover:border-blue-500/50 transition-all cursor-pointer relative"
 >
 ...
 productType === type 
 ? 'bg-blue-600 text-zinc-50 border-blue-400 shadow-lg shadow-blue-900/20' 
 ...
 <button 
 onClick={handleEntry}
 className="flex-1 px-6 py-4 bg-blue-600 hover:bg-blue-500 text-zinc-50 rounded-2xl font-bold text-xs uppercase tracking-widest shadow-lg shadow-blue-900/20 transition-all"
 >
 Registrar
 </button>
 </div>
 ...
 selectedItemForAction.action === 'remove' ? 'bg-red-600 text-zinc-50 shadow-lg shadow-red-900/40' : 'bg-slate-800 text-slate-500 hover:text-white '
 }`}
 >
 Saída
 </button>
 ...
 className={`py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all ${
 selectedItemForAction.action === 'add' ? 'bg-green-600 text-zinc-50 shadow-lg shadow-green-900/40' : 'bg-slate-800 text-slate-500 hover:text-white '
 }`}
 >
 Entrada
 </button>
