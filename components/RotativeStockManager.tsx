      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input 
            ...
            className="w-full bg-slate-100/60 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl px-12 py-4 text-slate-900 dark:text-white font-bold text-lg focus:border-blue-500/50 outline-none transition-all placeholder:text-slate-700"
          />
        </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl px-5 py-3.5 text-slate-900 dark:text-white font-bold text-lg focus:border-blue-500 outline-none transition-all outline-none"
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-[#0B1120] border border-slate-800 rounded-xl px-5 py-3.5 text-white font-bold text-lg focus:border-blue-500 outline-none transition-all appearance-none"
                  >
                    ...
                    {availableSlots.map(s => (
                      <option key={s.id} value={s.id} className="text-slate-200 bg-[#0B1120] text-lg">
                        {s.id}
                      </option>
                    ))}
                  </select>
