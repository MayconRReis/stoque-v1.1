...
const HistoryItem: React.FC<HistoryItemProps> = ({ entry }) => {
 return (
 <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex flex-col md:flex-row items-start md:items-center gap-4 hover:border-slate-700 transition-all group">
 ...
 <div className="bg-slate-950 px-4 py-2.5 rounded-xl border border-slate-800 min-w-[140px] text-center">
