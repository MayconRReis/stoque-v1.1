...
const QuickSearch: React.FC<QuickSearchProps> = ({ 
 ...
 className="absolute inset-y-2 right-2 px-6 bg-blue-600 hover:bg-blue-500 text-zinc-50 rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-lg active:scale-95 disabled:opacity-50"
 >
 ...
 >
 {/* Pallet Card */}
 <div className="bg-slate-900 backdrop-blur-xl border border-slate-800 rounded-[2.5rem] overflow-hidden shadow-2xl">
 ...
 <div className="grid grid-cols-2 gap-6 bg-slate-950 p-6 rounded-[2rem] border border-slate-800 ">
 <div className="space-y-1">
