...
export const UserManager: React.FC = () => {
 ...
 className="group relative flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-zinc-50 px-8 py-4 rounded-[2rem] font-black text-sm uppercase tracking-widest transition-all shadow-xl shadow-blue-900/20 active:scale-95"
 >
 ...
 className="w-full bg-slate-900 backdrop-blur-md border border-slate-800 rounded-[2rem] pl-14 pr-8 py-5 text-white font-bold focus:border-blue-500 outline-none transition-all placeholder:text-slate-700"
 />
 </div>
 ...
 className={`group bg-slate-900 backdrop-blur-md border rounded-[2.5rem] p-8 transition-all hover:bg-slate-900 ${
 ...
 <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest bg-slate-950 px-3 py-1 rounded-full">
 ...
 className="flex-1 flex items-center justify-center gap-2 bg-slate-950 hover:bg-slate-950 text-slate-400 hover:text-white px-4 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all border border-slate-800 "
 >
 ...
 className="flex-[2] py-6 bg-blue-600 hover:bg-blue-500 text-zinc-50 font-black text-xs uppercase tracking-[0.3em] rounded-3xl transition-all shadow-xl shadow-blue-900/20 flex items-center justify-center gap-3 disabled:bg-slate-800 disabled:text-slate-600"
 >
