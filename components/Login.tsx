...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
 ...
 <div className="bg-slate-900 backdrop-blur-2xl border border-slate-800 rounded-[48px] p-8 md:p-12 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.8)]">
 ...
 type="submit" 
 disabled={loading}
 className="w-full py-6 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-600 text-zinc-50 rounded-[28px] font-black text-sm uppercase tracking-[0.4em] transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-900/20 active:scale-[0.98]"
 >
 {loading ? (
