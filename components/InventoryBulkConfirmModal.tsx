...
export const InventoryBulkConfirmModal: React.FC<InventoryBulkConfirmModalProps> = ({ isOpen, onClose, onConfirm, onRemovePallet, selectedPallets }) => {
 ...
 return (
 <div className="fixed inset-0 z-[150] flex items-center justify-center bg-slate-950 backdrop-blur-2xl p-4 overflow-y-auto">
 ...
 <div className="bg-slate-800 p-8 flex justify-between items-center border-b border-slate-800 ">
 ...
 <button onClick={onClose} className="w-10 h-10 flex items-center justify-center bg-slate-950 rounded-xl text-slate-500 hover:text-white transition-all">
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div className="py-20 text-center border-2 border-dashed border-slate-800 rounded-[32px] bg-slate-900 ">
 ...
 return (
 <div key={selectionKey} className="bg-slate-950 border border-slate-800 p-5 rounded-3xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 group hover:border-purple-500/40 transition-all duration-300">
 ...
 <div className="flex items-center justify-between sm:justify-end gap-5 shrink-0 border-t sm:border-t-0 pt-4 sm:pt-0 border-slate-800 ">
 ...
 <div className="bg-slate-950 p-6 rounded-[32px] border border-slate-800 grid grid-cols-2 gap-8 relative overflow-hidden">
 ...
 className="flex-[2] py-5 bg-purple-600 hover:bg-purple-500 disabled:bg-slate-800 disabled:text-slate-600 text-zinc-50 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-xl shadow-purple-900/40 transition-all flex items-center justify-center gap-3 active:scale-95"
 >
