...
export const ShipmentDetailModal: React.FC<ShipmentDetailModalProps> = ({ 
 ...
 return (
 <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-950 backdrop-blur-xl p-4 overflow-y-auto">
 <AnimatePresence>
 {showDeleteConfirm && (
 <motion.div 
 ...
 className="fixed inset-0 z-[210] flex items-center justify-center bg-slate-950 backdrop-blur-md p-4"
 >
 ...
 className="flex-2 py-4 bg-red-600 text-zinc-50 font-black text-[10px] uppercase tracking-widest rounded-2xl shadow-lg shadow-red-900/40 transition-all hover:bg-red-500 active:scale-95 disabled:opacity-50"
 >
 ...
 >
 {/* Header */}
 <div className="p-8 border-b border-slate-800 flex justify-between items-center bg-slate-800 ">
 <div className="flex items-center gap-4">
 <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-zinc-50 shadow-2xl transform -rotate-3 ${shipment.type === ShipmentType.THIRD_PARTY ? 'bg-fuchsia-600 shadow-fuchsia-900/40' : 'bg-pink-600 shadow-pink-900/40'}`}>
 ...
 className="px-6 bg-fuchsia-600 hover:bg-fuchsia-500 disabled:bg-slate-800 text-zinc-50 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-fuchsia-900/20 active:scale-95 transition-all"
 >
 Adicionar
 </button>
 </form>
 ...
 <div className="py-12 text-center border-2 border-dashed border-slate-800 rounded-[2rem] bg-slate-950 ">
 ...
 <div key={pallet.id} className="bg-slate-950 border border-slate-800 p-4 rounded-2xl flex items-center justify-between group hover:border-slate-700 transition-all">
 ...
 disabled={isProcessing}
 className="px-6 py-5 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-zinc-50 border border-red-500/20 rounded-2xl transition-all shadow-xl shadow-red-900/10"
 ...
 className="flex-[2] py-5 bg-green-600 hover:bg-green-500 disabled:bg-slate-800 text-zinc-50 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-xl shadow-green-900/40 transition-all flex items-center justify-center gap-3 active:scale-95"
 >
 {isProcessing ? (
