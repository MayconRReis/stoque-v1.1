  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-50/90 dark:bg-slate-950/90 backdrop-blur-xl p-4 overflow-y-auto">
          ...
          >
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-8 max-w-sm w-full shadow-3xl text-center space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-slate-900 dark:text-white font-black uppercase text-xl italic tracking-tight">Excluir Carregamento?</h3>
              ...
              <div className="flex gap-4 pt-2">
                <button 
                  ...
                  className="flex-1 py-4 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-black text-[10px] uppercase tracking-widest rounded-2xl transition-all hover:bg-slate-700"
                >
                  Cancelar
                </button>
                <button 
                  ...
                  className="flex-2 py-4 bg-red-600 text-slate-900 dark:text-white font-black text-[10px] uppercase tracking-widest rounded-2xl shadow-lg shadow-red-900/40 transition-all hover:bg-red-500 active:scale-95 disabled:opacity-50"
                >
      ...
      <motion.div 
        ...
        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[3rem] shadow-3xl w-full max-w-2xl overflow-hidden my-auto"
      >
        {/* Header */}
        <div className="p-8 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-200/20 dark:bg-slate-800/20">
          <div className="flex items-center gap-4">
            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-slate-900 dark:text-white shadow-2xl transform -rotate-3 ${shipment.type === ShipmentType.THIRD_PARTY ? 'bg-fuchsia-600 shadow-fuchsia-900/40' : 'bg-pink-600 shadow-pink-900/40'}`}>
              <Truck className="w-7 h-7" />
            </div>
            <div>
              <h3 className="text-2xl font-black text-slate-900 dark:text-white uppercase italic tracking-tighter">Detalhes do Carregamento</h3>
              <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em]">{shipment.id}</p>
            </div>
          </div>
          <button onClick={onClose} className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-950 text-slate-500 hover:text-slate-900 dark:hover:text-white flex items-center justify-center border border-slate-200 dark:border-slate-800 transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-8 space-y-8">
            ...
            <form onSubmit={handleSlotSearch} className="flex gap-3">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl pl-12 pr-4 py-4 text-slate-900 dark:text-white font-mono font-black text-sm focus:border-fuchsia-600 outline-none transition-all placeholder:text-slate-700"
                />
                {isSearching && (
              ...
              <button 
                ...
                className="px-6 bg-fuchsia-600 hover:bg-fuchsia-500 disabled:bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-fuchsia-900/20 active:scale-95 transition-all"
              >
                Adicionar
              </button>
            </form>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button 
              ...
              disabled={isProcessing}
              className="px-6 py-5 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-slate-900 dark:hover:text-white border border-red-500/20 rounded-2xl transition-all shadow-xl shadow-red-900/10"
