...
export const MovementModal: React.FC<MovementModalProps> = ({ 
 ...
 {!isFlat && (
 <div className="bg-slate-950 p-6 md:p-8 flex justify-between items-center border-b border-slate-800 relative overflow-hidden">
 ...
 <button 
 onClick={onClose} 
 className="w-10 h-10 flex items-center justify-center bg-slate-950 rounded-xl text-slate-500 hover:text-white hover:bg-slate-800 border border-slate-800 transition-all group"
 >
 ...
 type === 'entry' 
 ? 'bg-blue-600 text-zinc-50 shadow-lg shadow-blue-900/40 translate-y-[-1px]' 
 ...
 className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] transition-all duration-300 flex items-center justify-center gap-2 ${
 type === 'transfer' 
 ? 'bg-amber-600 text-zinc-50 shadow-lg shadow-amber-900/40 translate-y-[-1px]' 
 : 'text-slate-500 hover:text-slate-300 hover:bg-slate-900 '
 }`}
 >
 ...
 className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] transition-all duration-300 flex items-center justify-center gap-2 ${
 type === 'exit' 
 ? 'bg-red-600 text-zinc-50 shadow-lg shadow-red-900/40 translate-y-[-1px]' 
 : 'text-slate-500 hover:text-slate-300 hover:bg-slate-900 '
 }`}
 >
 ...
 className="p-5 bg-slate-950 border border-slate-800 rounded-2xl space-y-6"
 >
 ...
 className="w-full py-5 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-600 text-zinc-50 rounded-[2rem] font-black text-[11px] uppercase tracking-[0.25em] transition-all duration-300 flex items-center justify-center gap-3 shadow-2xl shadow-blue-900/40 active:scale-[0.98] group"
 >
 Confirmar Entrada 
 ...
 <span className="inline-block text-[8px] font-black text-zinc-50 bg-amber-600/30 px-2.5 py-1 rounded-full border border-amber-500/30 uppercase tracking-wider">
 {foundPallet.status}
 </span>
 </div>
 </div>
 ...
 className="w-full py-5 bg-amber-600 hover:bg-amber-500 disabled:bg-slate-800 disabled:text-slate-600 text-zinc-50 rounded-[2rem] font-black text-[11px] uppercase tracking-[0.25em] transition-all duration-300 flex items-center justify-center gap-3 shadow-2xl shadow-amber-900/40 active:scale-[0.98] group"
 >
 ...
 <span className="inline-block text-[8px] font-black text-zinc-50 bg-red-600/30 px-2.5 py-1 rounded-full border border-red-500/30 uppercase tracking-wider">
 ...
 className="w-full py-5 bg-red-600 hover:bg-red-500 disabled:bg-slate-800 disabled:text-slate-600 text-zinc-50 rounded-[2rem] font-black text-[11px] uppercase tracking-[0.25em] transition-all duration-300 flex items-center justify-center gap-3 shadow-2xl shadow-red-900/40 active:scale-[0.98] group"
 >
 ...
 return (
 <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950 backdrop-blur-xl p-4 overflow-y-auto">
 <motion.div 
