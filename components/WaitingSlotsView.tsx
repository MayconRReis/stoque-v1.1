...
export const WaitingSlotsView: React.FC<WaitingSlotsViewProps> = ({ items, onAssignSlot }) => {
 ...
 whileHover={{ y: -5 }}
 className="group bg-slate-900 backdrop-blur-xl rounded-[2.5rem] border border-slate-800 hover:border-amber-500/50 transition-all p-7 relative overflow-hidden flex flex-col h-full shadow-lg hover:shadow-amber-500/10"
 >
 ...
 <div className="bg-slate-950 p-3.5 rounded-2xl border border-slate-800 group-hover:border-slate-800 transition-colors">
 ...
 className="w-full py-4 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-zinc-50 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.25em] transition-all shadow-xl shadow-amber-900/40 active:scale-95 flex items-center justify-center relative overflow-hidden"
 >
 ESCOLHER VAGA
 </button>
 </div>
